						...
						<div class='panel-body'>
							...
							<table class="table table-hover table-bordered">
							  ...
							  <tbody>
								...
								?>
								<tr>
								<td><?PHP echo $app->jadikan_id_pelanggan($pelanggan['id_pelanggan']); ?></td>
								<td><?PHP echo $pelanggan['nama_pelanggan']; ?></td>
								<td><?PHP echo $pelanggan['hp_pelanggan']; ?></td>
								<td>
								<div class="btn-group">
								  <a href="edit_pelanggan.php?id=<?PHP echo $pelanggan['id_pelanggan']; ?>" class="btn btn-xs btn-success" title='Edit'> <i class="fa fa-edit"></i> </a> 
								  <a onclick="return confirm('Are you sure you want to delete this data?');" href="pelanggan.php?act=hapus&id=<?PHP echo $pelanggan['id_pelanggan']; ?>" class="btn btn-xs btn-danger"> <i class="fa fa-remove" title='Hapus'></i> </a> 
								</div>
								</td>
								</tr>
